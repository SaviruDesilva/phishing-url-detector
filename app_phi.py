...
def extract_features_for_model(url):
    ...
    # NOTE: Keeping your typos ('Degit', 'Spacial') to match the model training data
    ...
    # 3.3 Statistical/Probability Defaults (To prevent Model Crash)
    defaults = {
...
try:
    ...
    st.error("⚠️ CRITICAL: 'model.pkl' or 'encoder.pkl' not found. Please place them in the same folder.")
    st.stop()
